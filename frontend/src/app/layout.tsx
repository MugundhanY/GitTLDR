...
export const metadata: Metadata = {
  ...
  verification: {
    google: '2y3P30Y_WQknuJwQfINN_5YiH3fnMQXEr1_klP0opDg',
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-MCK337LP');`,
          }}
        />
      ...
      <body className={inter.className}>
        ...
        <noscript>
          <iframe 
            src="https://www.googletagmanager.com/ns.html?id=GTM-MCK337LP"
            height="0" 
            width="0" 
