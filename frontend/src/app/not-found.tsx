...
export default function Custom404() {
  ...
  style={{
    ...
    `,
      ...
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 z-10" style={{ borderRadius: '500px', }}>
    ...
    rgb(0, 255, 166) 360deg
      ...
      <div className="relative z-[60] flex flex-col items-center justify-center w-full mx-auto text-center">
        ...
        <h1 
  className="lg:text-[3.85rem] text-4xl lg:text-6xl md:text-5xl sm:text-4xl font-medium mb-6 lg:max-w-2xl md:max-w-lg sm:max-w-sm"
  style={{
...
>
  Oops! This page is playing hide and seek.
        ...
        <p 
          className="lg:text-xl md:text-lg mb-8 lg:max-w-sm font-normal"
          style={{
        ...
        >
          {userData? "Let's get you back on track. Explore more or return to the dashboard." : "Let's get you back on track. Explore more or return to the homepage."}
        </p>
  ...
  style={{
    backgroundColor: "#fff",
                                borderRadius: "12px",
                                boxShadow: isButtonHovered? "rgba(255,255,255,0.75) 0px 0px 10px 1px inset, 0px 0px 16px 4px rgba(255,255,255,0.35)"
...
>
  ...
  >
    {userData? 'Back to Dashboard' : 'Back to Home'}
  </span>
</a>
