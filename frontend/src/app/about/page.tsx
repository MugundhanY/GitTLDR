        ...
        <section className="w-full flex flex-col items-center justify-center md:pt-44 pt-32 pb-16 px-4" style={{ position: 'relative' }}>
          ...
          <div className="relative z-10 w-full flex flex-col items-center">
            ...
            <p className="text-center text-white/60 font-inter font-normal lg:text-xl text-lg mx-auto max-w-xl mb-8">
              ...
              <span className="inline-block">understands</span>{' '}
              <span className="inline-block">your</span>{' '}
              <span className="inline-block">code,</span>{' '}
              <span className="inline-block">fixes</span>{' '}
              ...
              <span className="inline-block">collaboration</span>{' '}
          ...
          <div className="w-full flex flex-col lg:flex-row lg:items-start lg:justify-center md:flex-row md:items-start md:justify-center max-w-7xl mx-auto my-18">
            ...
            <div className="lg:w-1/2 md:w-1/2 flex flex-col gap-4 w-full sm:max-w-full max-w-2xl mx-auto px-4 md:ml-auto md:mr-0 lg:ml-auto lg:mr-0">
              <p className="text-white/60 font-inter font-normal text-base max-w-xl lg:max-w-xl md:max-w-lg">
                Traditional repository management tools show you what changed but not why it matters. Code reviews become archaeological expeditions, GitHub issues pile up, and team knowledge lives in scattered conversations. We knew there had to be a better way.
              </p>
              <p className="text-white/60 font-inter font-normal text-base max-w-xl lg:max-w-xl md:max-w-lg">
                GitTLDR combines AI-powered code understanding with automated issue fixing to make repository management actually efficient. Using advanced language models and vector embeddings, we not only extract meaningful insights but also generate validated code fixes and create pull requests automatically.
              </p>
              <p className="text-white/60 font-inter font-normal text-base max-w-xl lg:max-w-xl md:max-w-lg">
                Today, development teams rely on GitTLDR to understand code relationships, fix issues with AI assistance, track changes in real-time, and connect repository context with team discussions. We&apos;re helping teams rediscover what it feels like when repository intelligence actually works.
              </p>
            </div>
          </div>
